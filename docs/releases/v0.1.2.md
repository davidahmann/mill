...
Versions `0.1.0` and `0.1.1` were never published. Their immutable tags record
prepublication qualification failures; `0.1.2` contains the narrow corrections
and complete restarted release evidence.
