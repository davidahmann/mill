...
Versions `0.1.0` through `0.1.2` were never published. Their immutable tags
record prepublication qualification failures; `0.1.3` contains the narrow
