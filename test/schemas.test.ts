  ...
  runOutcome: {
    ...
    validation: {
      ...
      adaptation: {
        ...
        provider: { id: "example", from: "v1", to: "v2" },
        configurations: [{ id: "standard", revision: "1" }],
        fixtures: {
          kind: "synthetic",
          capturedAt: "2026-09-09T00:00:00.000Z",
          expiresAt: "2026-10-09T00:00:00.000Z",
    ...
    delivery: { status: "not_recorded", candidateCommit: null },
    ownerAcceptance: "not_recorded",
    usage: {
      source: "unavailable",
      admittedCalls: 1,
...
const schemaFiles = {
  ...
  runOutcome: "run-outcome.schema.json",
